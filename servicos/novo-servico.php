...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO servicos_prestadores(nome_serv,finalidade,preco,dias,cidades,tam_equipe,img_serv) VALUES ('$nome_serv','$finalidade','$preco','$dias','$cidades','$tam_equipe','$img_serv')");
...
<body>
    <div class="box">
        <form action="novo-servico.php" method="POST" enctype="multipart/form-data">
            <fieldset>
                <legend><b>Cadastrar novo servi�o</b></legend>
                <br>
                <div class="inputBox">
                    <input type="text" name="nome_serv" id="nome_serv" class="inputUser" required>
                    <label for="nome_serv" class="labelInput">Nome do servi�o</label>
                </div>
                <br><br>
                <div class="inputBox">
                ...
                <div class="inputBox">
                    ...
                    <label for="preco" class="labelInput">Pre�o (R$)</label>
                </div>
                <br><br>
                <div class="inputBox">
